  ...
  return (
    <TiltCard className="h-full">
      <motion.div
        ...
        className="group relative glass-card p-5 h-full hover:bg-foreground/[0.05] transition-all duration-500 border-foreground/5 flex flex-col"
      >
        ...
        <div className="aspect-square relative rounded-2xl overflow-hidden mb-6 bg-background/40 border border-foreground/5">
          <img 
            src={mudra.image} 
            alt={mudra.name} 
          ...
          <div className="absolute inset-0 bg-background/40 opacity-0 group-hover:opacity-100 transition-opacity duration-300 flex items-center justify-center backdrop-blur-sm">
             <Link 
               ...
               className="bg-foreground text-background px-6 py-2.5 rounded-full font-black text-[10px] uppercase tracking-widest transform translate-y-4 group-hover:translate-y-0 transition-all duration-500 shadow-xl"
             >
               Practice Now
             </Link>
          </div>
        ...
        <div className="space-y-4 flex-1 flex flex-col">
          <div className="flex items-start justify-between">
            <div>
              ...
              <h3 className="text-2xl font-black text-foreground tracking-tight group-hover:text-primary transition-colors">{mudra.name}</h3>
            </div>
            <Link href={`/library/${mudra.slug}`}>
              <div className="p-2 rounded-lg bg-foreground/5 hover:bg-primary/20 hover:text-primary transition-all border border-foreground/5 flex items-center space-x-2 px-3">
          ...
          <div className="mt-auto pt-6 flex items-center justify-between border-t border-foreground/5">
            <div className="flex items-center space-x-2 text-[10px] text-foreground/30 uppercase font-black tracking-widest">
            ...
            <div className="flex items-center space-x-3">
               <Link 
                href={`/practice/${mudra.slug}`}
                className="text-[10px] font-black uppercase text-primary hover:text-foreground transition-colors bg-primary/10 hover:bg-primary px-3 py-1.5 rounded-lg border border-primary/20"
               >
                 Practice
               </Link>
